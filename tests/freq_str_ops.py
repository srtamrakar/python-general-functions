...
def test_009_to_alpha_numeric():
	assert StrOps.text_to_alpha_numeric('abc yyyy/mm/dd', replace_string='_') == 'abc_yyyy_mm_dd'
...
def test_015_text_to_snake_case_from_normal():
	assert StrOps.text_to_snake_case('abc def yyyy/mm-dd 123', case='lower') == 'abc_def_yyyy_mm_dd_123'
